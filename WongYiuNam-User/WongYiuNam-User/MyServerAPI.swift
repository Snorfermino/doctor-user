...
//    }
    ...
    var task: Task {
        ...
        case .login(let email, let password):
            ...
            //return Task.uploadCompositeMultipart([MultipartFormData(provider: .data(UIImagePNGRepresentation(#imageLiteral(resourceName: "ic_check"))), name: "photo", fileName: "photo.png", mimeType: "image/png")], urlParameters: [""])
